...
import 'add_family_memeber_model.dart';
export 'add_family_memeber_model.dart';

class AddFamilyMemeberWidget extends StatefulWidget {
  const AddFamilyMemeberWidget({Key? key}) : super(key: key);
...
class _AddFamilyMemeberWidgetState extends State<AddFamilyMemeberWidget> {
  late AddFamilyMemeberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFamilyMemeberModel());
