...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CreateUserAccountWidget(),
        ),
        FFRoute(
          name: 'CreateElderFamilyMember',
          path: '/createElderFamilyMember',
          builder: (context, params) => CreateElderFamilyMemberWidget(),
        )
